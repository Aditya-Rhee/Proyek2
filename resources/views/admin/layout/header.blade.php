        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        @if(Auth::user()->image)
                            <img alt="image" src="{{ asset('images/' . Auth::user()->image) }}" class="rounded-circle mr-1">
                        @else
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="{{ route('editprofile', Auth::user()->id) }}" class="dropdown-item has-icon">
                            <i class="far fa-user"></i> Profile
                        </a>
                        <a href="{{ route('datasettings') }}" class="dropdown-item has-icon">
